...
const msaPubUrl = process.env.VUE_APP_API_MSA_PUB_PREFIX

const downloadUrl = 'https://m.winfo.pub/sz/service-ftp/ftp/downLoad?fileUuid='
const viewUrl = 'https://m.winfo.pub/sz/service-ftp/ftp/view?fileUuid='

export { baseUrl, downloadUrl, viewUrl, preUrl, msaUrl, msaPubUrl }
